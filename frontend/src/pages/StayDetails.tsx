    ...
    <MainLayout>
          ...
          <div>
            ...
            <Card className="p-6 sticky top-24 mb-6">
              ...
              <div className="space-y-4">
                ...
                <Button className="w-full" size="lg" onClick={() => setIsChatOpen(true)}>
                  Contact Host
                </Button>
              </div>
      ...
      {stay && (
        <ChatDialog
          ...
          hostId={stay.host.email || stay.id.toString()}
          hostName={stay.host.name}
          hostImage={getFullImageUrl(stay.host.image)}
          experienceId={parseInt(id || '0')}
        />
      )}
    </MainLayout>
  );
